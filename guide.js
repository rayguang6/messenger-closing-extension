// guide.js
// This file contains the full closing guide as a constant string for use in the extension
...
Daily Action:
- Leave 10 Quality Comments on Other People's Facebook Group Posts
- Add 10 "Quality" Friend Requests
If you hit the friend request limit, you can split it into 5 in the morning
and 5 at night.
You need a good ratio of people accepting your friend request, or else it will be limited more easily. So before you send it, make sure you've already built a relationship with him somewhere. Either commented below his posts, several times, or he replied to your PM.

add "quality" friends

So before you send, make sure you've already built a relationship with him somewhere.
Either commented below his posts several times or he replied to your PM
...
3. Keep the introduction SHORT and aim for a reply: don't waste too
...
YOU: Btw have you seen my portfolio yet? I'm happy to send over some of our most recent funnel designs if you want?
...
Answer: Yes, I'm fine. Is there something specific you'd like to follow up on or any new developments?
...
4. If you're unsure of whether it is a good country, check their average
...
Priorities: (Clarity of needs) Precise goals → Still developing goals →
Open to inspiration
Ways to handle:
...
● Precise and clear: We are an online book store looking to increase our sales through a more effective sales funnel.
● Uncertain:I'mnotsure.Weneedbetteronlinesales&traffic.
● Technicalneeds:Weneedabookingsystemandsecurepayments.
● Design-oriented:Wewantamodern,visuallyappealingsite.
● Traffic-focused:Weneedablogandsocialmediaintegration.
...
whenever you're unclear

- Objection: Another person offered me a lower price.
- Oh, what do you mean by that?
- Do you mean you like his design more?
Note: If he's still speaking with you, chances are, he likes you more, just need to negotiate a bit on price
...
-Pay in full today:If you pay in full today, then...

EXAMPLES/ SCENARIO:
DM1: CONCERN ABOUT PRICE
Objection: The price seems too high.

Client: Hey, I really like your portfolio, but I noticed your rate is $500 for a project like this. That's a bit out of my budget.
...
Client: That sounds fair. I appreciate the discount and I'd be happy to write a testimonial if the work meets my expectations. Let's do it!
...
Client: "Next Month"
YOU: Okay sounds good! I'll follow up with you again next month.
(For TIME objection, don't push too hard, just get a clearer view on when the potential client will want to start, and mark it in your calendar, send a follow up message by then)
...
2. Refer to Jackson Live Coaching to learn "How to close like a pro". https://www.skool.com/ai-agency-30-8665/classroom/505f99e4?md=4e4ac533b0 384edc9fa7d3ba894dba48
3. The sales sequences for online appointment: Opening → Discovery → Transition → Offer → Objection*
...
YOU:
● Hey,how'severythinggoing?
● Hi[Client'sName],justfollowinguponmylastmessage.Letme
know if you have any questions. Thanks!
● Hey, did you get a chance to review my previous message? I'd
love to chat more.
● Hello, hope you're doing well! Any thoughts on my last
message?
● Hey, I'm reaching out again to see if you're interested in
[service/offer]. Happy to chat anytime.
● Hi, just checking in. I'm here to help with [service/offer]. Let me
know if you're interested.
● Hey, just checking if you're interested in discussing
...
YOU: I'll design a one-page website for you, including your homepage with all the essential information and branding. If you're happy with it and want more pages or features, we can discuss a paid plan.
...
videos.
YOU: We can discuss the specific content you need and how I can assist you. Do you have any initial ideas or themes in mind? Answer: I have a few ideas but didn't have much time to gather them
yet.
...
#8: Don't worry about your English. #9: Follow the sales flow.

🕵️‍♂️ LIKE A DETECTIVE
"Research and make sure they are a qualified person for you."
Focused on the international market, USA, Canada, Europe…

🕸️ LIKE A HUNTER
"Set up a good profile, lay some traps, and let them come to you."
Observe them carefully, and then give them your best shot.

😎 LIKE A CHARMER
"Just like chasing a girl, don't rush, don't scare them away."
Just keep it short and aim for a reply; that means you still have a chance.

⚖️ LIKE A STRATEGIST
"Always offer a plan, but ensure you get something in return."
If you like my work, can you provide a testimonial in return?

🧠 LIKE A CONSULTANT
"Provide valuable advice and insights to build trust and demonstrate expertise."
Listen to them and find out what they really need. Keep it clear, and earn more money with less talk.


#Real life chat examples:
###Don't end up with statement such as
"ok, no problem" / "let's me go through your website first"

✅ Always end up with a magic question
eg:

What do you mean by that?

What problems are you hoping to solve with this?

###Don't send a long introduction; it can make you sound like a scammer.

Clients, like you, don't like to read long messages.
The goal is to open the conversation and aim for a reply.
Don't rush, they can know you more based on your profile.

Start with "hi" and a simple question to ensure they read your message.
Sometimes, a simple "hi" can also spark their curiosity.


###He might be a good potential client, but don't rush to make an offer.
Sometimes, you can also make an offer in exchange for something like a testimonial.

💬 (Blue text box)
Normally, I charge $500, but for this project, I'll do it for $300. If you like my work, can you provide a testimonial in return?
✅


###Be more direct and don't waste time on good chat opportunities.
Show your professionalism. It's a bad idea because it can undermine their confidence in your experience and abilities.
